...
[added]
- Now only inverts window 1 by default, you can change this by right-clicking the icon in the system tray
- Uses smart invert 1 by default

[fixed]
- Fixed a bug where the app would break if halted and the launched again

[planned]
- I am currently working on making a config file to change keyboard shortcuts, default windows, etc. 
...
-Press Win+Alt+F1-to-F10 to change inversion mode:
	...
	F2: (DEFAULT) smart inversion1 - theoretical optimal transfomation (but ugly desaturated pure colors)
