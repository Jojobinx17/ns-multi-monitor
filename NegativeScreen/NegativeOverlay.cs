...
namespace NegativeScreen
{
	public class NegativeOverlay : Form
	{
			...
			: base()
		{
			...
			//initial color transformation: uses the type listed in the config file (or the default if it can't find it)
			
			try 
			{
				Configuration config = new Configuration();

				switch(config.DefaultInversionMethod) {
					case 0:
						BuiltinMatrices.ChangeColorEffect(hwndMag, BuiltinMatrices.Negative);
						break;
					case 1:
						BuiltinMatrices.ChangeColorEffect(hwndMag, BuiltinMatrices.NegativeHueShift180);
						break;
					case 2:
						BuiltinMatrices.ChangeColorEffect(hwndMag, BuiltinMatrices.NegativeHueShift180Variation1);
						break;
					case 3:
						BuiltinMatrices.ChangeColorEffect(hwndMag, BuiltinMatrices.NegativeHueShift180Variation2);
						break;
					case 4:
						BuiltinMatrices.ChangeColorEffect(hwndMag, BuiltinMatrices.NegativeHueShift180Variation3);
						break;
					case 5:
						BuiltinMatrices.ChangeColorEffect(hwndMag, BuiltinMatrices.NegativeHueShift180Variation4);
						break;
					case 6:
						BuiltinMatrices.ChangeColorEffect(hwndMag, BuiltinMatrices.NegativeSepia);
						break;
					case 7:
						BuiltinMatrices.ChangeColorEffect(hwndMag, BuiltinMatrices.NegativeGrayScale);
						break;
					case 8:
						BuiltinMatrices.ChangeColorEffect(hwndMag, BuiltinMatrices.NegativeRed);
						break;
					case 9:
						BuiltinMatrices.ChangeColorEffect(hwndMag, BuiltinMatrices.Red);
						break;
				}
			}
			catch
